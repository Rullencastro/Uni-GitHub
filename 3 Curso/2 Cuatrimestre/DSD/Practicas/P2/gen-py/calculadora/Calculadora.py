...
class Client(Iface):
    ...
    def sumarMatriz(self, num1, num2):
        ...
        """
        self.send_sumarMatriz(num1, num2)
        return self.recv_sumarMatriz()

    def send_sumarMatriz(self, num1, num2):
        self._oprot.writeMessageBegin('sumarMatriz', TMessageType.CALL, self._seqid)
        args = sumarMatriz_args()
        args.num1 = num1
        args.num2 = num2
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_sumarMatriz(self):
        ...
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sumarMatriz failed: unknown result")
    ...
    def restarMatriz(self, num1, num2):
        ...
        """
        self.send_restarMatriz(num1, num2)
        return self.recv_restarMatriz()

    def send_restarMatriz(self, num1, num2):
        self._oprot.writeMessageBegin('restarMatriz', TMessageType.CALL, self._seqid)
        args = restarMatriz_args()
        args.num1 = num1
        args.num2 = num2
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_restarMatriz(self):
        ...
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "restarMatriz failed: unknown result")
    ...
    def multiplicarMatriz(self, num1, num2):
        ...
        """
        self.send_multiplicarMatriz(num1, num2)
        return self.recv_multiplicarMatriz()

    def send_multiplicarMatriz(self, num1, num2):
        self._oprot.writeMessageBegin('multiplicarMatriz', TMessageType.CALL, self._seqid)
        args = multiplicarMatriz_args()
        args.num1 = num1
        args.num2 = num2
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_multiplicarMatriz(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = multiplicarMatriz_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "multiplicarMatriz failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["sumarMatriz"] = Processor.process_sumarMatriz
        self._processMap["restarMatriz"] = Processor.process_restarMatriz
        self._processMap["multiplicarMatriz"] = Processor.process_multiplicarMatriz
    ...
    def process_sumarMatriz(self, seqid, iprot, oprot):
        args = sumarMatriz_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = sumarMatriz_result()
        try:
            result.success = self._handler.sumarMatriz(args.num1, args.num2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("sumarMatriz", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_restarMatriz(self, seqid, iprot, oprot):
        args = restarMatriz_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = restarMatriz_result()
        try:
            result.success = self._handler.restarMatriz(args.num1, args.num2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("restarMatriz", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_multiplicarMatriz(self, seqid, iprot, oprot):
        args = multiplicarMatriz_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = multiplicarMatriz_result()
        try:
            result.success = self._handler.multiplicarMatriz(args.num1, args.num2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("multiplicarMatriz", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class sumarMatriz_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.num1 = matriz()
                    self.num1.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.num2 = matriz()
                    self.num2.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sumarMatriz_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.STRUCT, 1)
            self.num1.write(oprot)
            oprot.writeFieldEnd()
        if self.num2 is not None:
            oprot.writeFieldBegin('num2', TType.STRUCT, 2)
            self.num2.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sumarMatriz_args)
sumarMatriz_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'num1', [matriz, None], None, ),  # 1
    (2, TType.STRUCT, 'num2', [matriz, None], None, ),  # 2
)


class sumarMatriz_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sumarMatriz_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sumarMatriz_result)
sumarMatriz_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [matriz, None], None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidOperation, None], None, ),  # 1
)


class restarMatriz_args(object):
    """
    Attributes:
     - num1
     - num2
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('restarMatriz_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.STRUCT, 1)
            self.num1.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(restarMatriz_args)
restarMatriz_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'num1', [matriz, None], None, ),  # 1
    (2, TType.STRUCT, 'num2', [matriz, None], None, ),  # 2
)
...
class restarMatriz_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('restarMatriz_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(restarMatriz_result)
restarMatriz_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [matriz, None], None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidOperation, None], None, ),  # 1
)


class multiplicarMatriz_args(object):
    """
    Attributes:
     - num1
     - num2
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicarMatriz_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.STRUCT, 1)
            self.num1.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicarMatriz_args)
multiplicarMatriz_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'num1', [matriz, None], None, ),  # 1
    (2, TType.STRUCT, 'num2', [matriz, None], None, ),  # 2
)
...
class multiplicarMatriz_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicarMatriz_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicarMatriz_result)
multiplicarMatriz_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [matriz, None], None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidOperation, None], None, ),  # 1
)
