...
function filtroPalabras(){
    ...
    //const censuradas = <?php echo json_encode($censuradas); ?>;
    //const censuradas = ['puta','cabron','pene','tonto','coño','mierda','subnormal','gilipollas','imbecil','idiota'];
    var comentario = document.getElementById("fcom").value;
    var arrayCom = comentario.split(" ");
    var cambio = false;

    //console.log(censuradas[1]);
